...
//     public async Task<Media?> ProcessAndInsertUploadedMedia(DatabaseConnection dbConn, Guid songId, IFormFile file, String filePath)
//     {
...
//     private async Task<string> xSaveFile(Guid songId, IFormFile file)
//     {
